...
export PATH="$PATH:/mnt/d/.application/mips/mips-4.3/bin"
#export DISPLAY=$(cat /etc/resolv.conf | grep nameserver | awk '{print $2}'):0
#export DISPLAY=$(route.exe print | grep 0.0.0.0 | head -1 | awk '{print $4}'):0.0
export PATH=/mnt/d/compiler/bin:$PATH
...
export CS61B_LIB_DIR="/mnt/d/.application/jdk19/library-sp18/javalib/*"
export CS61B_STYLE_DIR="/mnt/d/.application/jdk19/library-sp18/style/*"
export CLASSPATH="$CLASSPATH:$CS61B_LIB_DIR:./"
export CLASSPATH="$CLASSPATH:$CS61B_STYLE_DIR:./"
